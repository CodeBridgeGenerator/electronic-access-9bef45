...
import AccessGroupsPage from "../AccessGroupsPage/AccessGroupsPage";
import RoomsPage from "../RoomsPage/RoomsPage";
import SystemAccessLevelPage from "../SystemAccessLevelPage/SystemAccessLevelPage";
...
case "rooms":
                return <RoomsPage />;
case "systemAccessLevel":
                return <SystemAccessLevelPage />;
case "accessGroupRoomMap":
                return <AccessGroupRoomMapPage />;
      /* ~cb-add-thurthy~ */
      default:
...
<li
                onClick={() => {
                  setCurrentActiveTab2("accessGroups");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "accessGroups",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "accessGroups" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "accessGroups",
                      "text-black": props?.currentActiveTab2 !== "accessGroups",
                    })}
                  >
                  AccessGroups
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "accessGroups",
                      "text-yellow-700": props?.currentActiveTab2 !== "accessGroups",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("rooms");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "rooms",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "rooms" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "rooms",
                      "text-black": props?.currentActiveTab2 !== "rooms",
                    })}
                  >
                  Rooms
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "rooms",
                      "text-yellow-700": props?.currentActiveTab2 !== "rooms",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("systemAccessLevel");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "systemAccessLevel",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "systemAccessLevel" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "systemAccessLevel",
                      "text-black": props?.currentActiveTab2 !== "systemAccessLevel",
                    })}
                  >
                  SystemAccessLevel
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "systemAccessLevel",
                      "text-yellow-700": props?.currentActiveTab2 !== "systemAccessLevel",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("accessGroupRoomMap");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "accessGroupRoomMap",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "accessGroupRoomMap" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "accessGroupRoomMap",
                      "text-black": props?.currentActiveTab2 !== "accessGroupRoomMap",
                    })}
                  >
                  AccessGroupRoomMap
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "accessGroupRoomMap",
                      "text-yellow-700": props?.currentActiveTab2 !== "accessGroupRoomMap",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
