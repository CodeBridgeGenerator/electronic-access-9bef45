...
import SingleAccessGroupsPage from "../components/AccessGroupsPage/SingleAccessGroupsPage";
import AccessGroupProjectLayoutPage from "../components/AccessGroupsPage/AccessGroupProjectLayoutPage";
import SingleRoomsPage from "../components/RoomsPage/SingleRoomsPage";
import RoomProjectLayoutPage from "../components/RoomsPage/RoomProjectLayoutPage";
import SingleSystemAccessLevelPage from "../components/SystemAccessLevelPage/SingleSystemAccessLevelPage";
import SystemAccessLevelProjectLayoutPage from "../components/SystemAccessLevelPage/SystemAccessLevelProjectLayoutPage";
import SingleAccessGroupRoomMapPage from "../components/AccessGroupRoomMapPage/SingleAccessGroupRoomMapPage";
import AccessGroupRoomMapProjectLayoutPage from "../components/AccessGroupRoomMapPage/AccessGroupRoomMapProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/accessGroups/:singleAccessGroupsId" exact element={<SingleAccessGroupsPage />} />
<Route path="/accessGroups" exact element={<AccessGroupProjectLayoutPage />} />
<Route path="/rooms/:singleRoomsId" exact element={<SingleRoomsPage />} />
<Route path="/rooms" exact element={<RoomProjectLayoutPage />} />
<Route path="/systemAccessLevel/:singleSystemAccessLevelId" exact element={<SingleSystemAccessLevelPage />} />
<Route path="/systemAccessLevel" exact element={<SystemAccessLevelProjectLayoutPage />} />
<Route path="/accessGroupRoomMap/:singleAccessGroupRoomMapId" exact element={<SingleAccessGroupRoomMapPage />} />
<Route path="/accessGroupRoomMap" exact element={<AccessGroupRoomMapProjectLayoutPage />} />
