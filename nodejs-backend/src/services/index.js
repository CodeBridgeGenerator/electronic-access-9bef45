...
const accessGroups = require("./accessGroups/accessGroups.service.js");
const rooms = require("./rooms/rooms.service.js");
const systemAccessLevel = require("./systemAccessLevel/systemAccessLevel.service.js");
const accessGroupRoomMap = require("./accessGroupRoomMap/accessGroupRoomMap.service.js");
...
module.exports = function (app) {
  ...
  app.configure(accessGroups);
  app.configure(rooms);
  app.configure(systemAccessLevel);
  app.configure(accessGroupRoomMap);
